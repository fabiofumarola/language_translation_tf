...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    for sentence in source_text.split('\n'):
        ...
        for w in sentence.split():
            if w in source_vocab_to_int:
                sentence_ids.append(source_vocab_to_int[w])
    ...
    for sentence in target_text.split('\n'):
        sentence_ids = []
        for w in sentence.split():
            if w in target_vocab_to_int:
                sentence_ids.append(target_vocab_to_int[w])
...
def model_inputs():
    ...
    return input_, target_, l_rate, keep_prob
...
def decoding_layer(dec_embed_input, dec_embeddings, encoder_state, vocab_size, sequence_length, rnn_size,
    ...
    dec_cell = tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.LSTMCell(rnn_size)] * num_layers)
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    """
    return [vocab_to_int[w.lower()] if w in vocab_to_int else vocab_to_int['<UNK>'] for w in sentence.split()]
